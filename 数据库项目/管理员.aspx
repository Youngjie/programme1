<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="管理员.aspx.cs" Inherits="数据库项目.管理员" %>
						...
						<form action="" method="post" name="login" id="login-form">
						  <fieldset class="input">
						    <p id="login-form-username">
						      ...
						      <input id="modlgn_username" type="text" name="email" class="inputbox" size="18" autocomplete="off" runat="server">
						    </p>
						    <p id="login-form-password">
						      <label for="modlgn_passwd">Password</label>
						      <input id="modlgn_passwd" type="password" name="password" class="inputbox" size="18" autocomplete="off" runat="server">
						    </p>
						    <div class="remember">
				 ...
				 <div class="section group example">
				   <div class="col_1_of_f_2 span_1_of_f_2">
				      <h3>Facebook</h3>
						...
						<div class="like_box">	
							<div class="fb-like-box" data-href="http://sc.chinaz.com/moban/" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="true"></div>
						</div>
 				  </div>
				  <div class="col_1_of_f_2 span_1_of_f_2">
						<h3>From Twitter</h3>
